defmodule Pinochle.Card do
  ...
  @spec first_wins?(first :: Pinochle.Card.t(), second :: Pinochle.Card.t(), trump :: suit()) :: boolean()
  ...
  @spec second_wins?(first :: Pinochle.Card.t(), second :: Pinochle.Card.t(), trump :: suit()) :: boolean()
